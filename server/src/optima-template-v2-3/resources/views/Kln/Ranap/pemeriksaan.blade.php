...
<div class="row">
            ...
            <div class="table-responsive">
              <table id="tData" class="table table-striped table-bordered table-hover" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr
                    onclick="grid_edit({{$pmKey}},{{$primaryKey}}),set_list_histori({{$pmKey}})">
                    {{-- onclick="grid_edit({{$pmKey}},{{$primaryKey}}),enable_button(),set_list_pemeriksaan({{$pmKey}}),set_list_histori({{$pmKey}}),set_informasi_pasien_resep({{$pmKey}},{{$primaryKey}})"> --}}
  ...
  <div class="col-xl-3">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <input type="text" id="{{$primaryKey}}" name="{{$primaryKey}}" value="">
        ...
        <div class="text-left mt-2">
            <button onclick="enable_button()" class="btn btn-danger" data-toggle="modal" data-target="#pasien_keluar">
  ...
  <div class="col-xl-9">
    ...
    {{-- Modal Pemeriksaan --}}
    <div id="modalpemeriksaan" class="modal fade" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="text" id="tgl_periksa">
            <fieldset class="mb-2">
                  ...
                  <div class="col-xl-12">
                    ...
                    <div class="text-right">
                      <button type="submit" class="btn btn-primary" id="anamnesa_button" onclick="saveAnamnesa()"
                        ><i class="icon-floppy-disk mr-1"></i> Save</button>
                    </div>
                    <br>
                  </div>
                          ...
                          <div class="col-sm-6">
                            <div class="text-right">
                              <button type="submit" class="btn btn-primary" id="resep_button"
                                onclick="resep({{$primaryKey}})" ><i class="icon-floppy-disk mr-1"></i>
                                Save</button>
                            </div>
                          </div>
                        </div>
...
$(document).ready(function() {
  ...
  function saveAnamnesa()
  {
    ...
    postdata.rawatTglDaftar = $('#tgl_periksa').val();
    for (var j = 0; j < fieldobj.length; j++) {
